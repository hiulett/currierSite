<div class="container-fluid p-4">
    <div class="row mb-3 align-items-center">
        <div class="col-auto">
            <a href="{{ route('billing.index') }}" class="btn btn-light border">
                <i class="align-middle" data-feather="arrow-left"></i> Volver a Facturación
            </a>
        </div>
        <div class="col">
            <h4 class="mb-0 fw-black text-uppercase">Editar Factura: <span class="text-primary">{{ $invoice->number }}</span></h4>
            <p class="text-muted small mb-0">Modifica los conceptos, cliente o carga asociada a esta factura.</p>
        </div>
    </div>
                ...
                @if($found_customer && !empty($availablePackages))
                    <div class="card shadow-none border mb-3 mt-3">
                        <div class="card-header bg-success-light py-2">
                            <h6 class="card-title mb-0 small font-black uppercase text-success">Carga Pendiente o Asociada</h6>
                        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" class="btn btn-lg btn-success py-3 fw-black text-uppercase tracking-widest shadow-lg">
                        <i class="align-middle me-2" data-feather="save"></i> GUARDAR CAMBIOS
                    </button>
                </div>
            </div>
        </div>
