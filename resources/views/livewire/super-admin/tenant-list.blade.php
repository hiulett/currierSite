                                        ...
                                        <tbody>
                                            @php
                                                $modulesMap = [
                                                    ...
                                                    'recepcion_paquetes' => 'Recepción de Paquetes',
                                                    'control_manifiestos' => 'Control Manifiestos',
                                                    'inventario_activo' => 'Inventario Activo',
                                                    'rastreo_global' => 'Rastreo Global',
                                                    'reempaque_consolidacion' => 'Reempaque / Consolidación',
                                                    'casilleros_fisicos' => 'Casilleros Físicos',
                                                    'embarques' => 'Embarques (Outbound)',
                                                    'ultima_milla' => 'Última Milla (Delivery)',
                                                    'entrega_counter' => 'Entrega en Counter',
                                                    'base_clientes' => 'Base de Clientes',
                                                    'soporte_tickets' => 'Soporte (Tickets)',
                                                    'facturacion' => 'Facturación',
                                                    'cotizaciones' => 'Cotizaciones',
                                                    'control_fletes' => 'Control de Fletes',
                                                    'estados_cuenta' => 'Estados de Cuenta',
                                                    'expenses' => 'Egresos de Empresa',
                                                    'reportes_negocio' => 'Reportes de Negocio',
                                                    'identidad_visual' => 'Identidad Visual',
                                                    'gestion_bodegas' => 'Gestión de Bodegas',
                                                    'pagos_integraciones' => 'Pagos e Integraciones',
                                                    'ajustes_correo' => 'Ajustes de Correo',
                                                    'estados_carga' => 'Estados de Carga',
                                                    'niveles_cliente' => 'Niveles de Cliente',
