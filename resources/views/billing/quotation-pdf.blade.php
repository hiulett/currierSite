...
<body>
    ...
    <div class="footer">
        Este documento es una cotización comercial generada por {{ $tenant->name ?? config('app.name') }} y no representa una factura fiscal ni obliga a su pago. Los precios están sujetos a cambios.
    </div>
</body>
</html>
